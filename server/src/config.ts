...
export const settings = {
  ...
  previewTimeoutMs: Number(process.env.PREVIEW_TIMEOUT_MS ?? 45_000),
  previewSelectorTimeoutMs: Number(process.env.PREVIEW_SELECTOR_TIMEOUT_MS ?? 30_000),
  previewRenderWaitMs: Number(process.env.PREVIEW_RENDER_WAIT_MS ?? 5_000),
  ...
  chromeCdpEnabled: process.env.CHROME_CDP_ENABLED !== "false",
  chromeCdpUrl: process.env.CHROME_CDP_URL ?? "http://127.0.0.1:19222",
} as const;
